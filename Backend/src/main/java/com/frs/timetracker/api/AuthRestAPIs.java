...
import com.frs.timetracker.domain.SignInObj;
import com.frs.timetracker.message.request.LoginForm;
import com.frs.timetracker.message.request.SignUpForm;
import com.frs.timetracker.message.response.JwtResponse;
import com.frs.timetracker.security.jwt.JwtProvider;
...
public class AuthRestAPIs {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginForm loginRequest) {
        ...
        return ResponseEntity.ok(new SignInObj(userRepository.findByUsername(loginRequest.getUsername()), new JwtResponse(jwt)));
    }
